...
class TextInput:
    ...
    def __init__(
        ...
        self.final_string = initial_string
        ...
        for event in events:
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pl.K_BACKSPACE:
                    if len(self.input_string) == 0 and len(self.final_string) > 0:
                        self.final_string = self.final_string[:-1]
                        if ' ' in self.final_string:
                            self.input_string = self.final_string[self.final_string.rindex(' ')+1:]
                            self.final_string = self.final_string[:self.final_string.rindex(' ')+1]
                        else:
                            self.input_string = self.final_string
                            self.final_string = ''
                    ...
                    self.final_string += self.input_string
